    ...
    <div className="grid grid-cols-4 grid-rows-2 gap-4 mb-8 h-[500px]">
      ...
      <div className="col-span-2 row-span-2 relative">
        ...
        <input
          type="text"
          value={gallery[0]}
          onChange={(e) => onGalleryChange(0, e.target.value)}
      ...
      <div className="relative">
        ...
        <input
          type="text"
          value={gallery[1]}
          onChange={(e) => onGalleryChange(1, e.target.value)}
          placeholder="https://placehold.co/600x400"
      ...
      <div className="relative">
        ...
        <input
          type="text"
          value={gallery[2]}
          onChange={(e) => onGalleryChange(2, e.target.value)}
          placeholder="https://placehold.co/600x400"
          className="text-sm w-11/12 p-2 border border-primary rounded-lg mt-2 absolute left-1/2 -translate-x-1/2 bottom-2 bg-white"
        />
      </div>
      ...
      <div className="relative">
        ...
        <input
          type="text"
          value={gallery[3]}
          onChange={(e) => onGalleryChange(3, e.target.value)}
          placeholder="https://placehold.co/600x400"
          className="text-sm w-11/12 p-2 border border-primary rounded-lg mt-2 absolute left-1/2 -translate-x-1/2 bottom-2 bg-white"
        />
      </div>
      ...
      <div className="relative">
        ...
        <input
          type="text"
          value={gallery[4]}
          onChange={(e) => onGalleryChange(4, e.target.value)}
          placeholder="https://placehold.co/600x400"
          className="text-sm w-11/12 p-2 border border-primary rounded-lg mt-2 absolute left-1/2 -translate-x-1/2 bottom-2 bg-white"
        />
      </div>
